...
// Fixed imports with default exports - same as working parse-resume route
...
async function extractTextFromPDF(buffer) {
  try {
    ...
    console.log('✅ PDF text extraction successful, length:', pdfData.text.length);
    return pdfData.text;
  } catch (error) {
...
export async function POST(request) {
  console.log('🚀 === FLASK ML RESUME ANALYSIS STARTED ===');
  ...
  try {
    ...
    console.log('📄 Processing resume ID for Flask ML analysis:', resumeId);
    ...
    console.log('✅ Resume found for Flask ML analysis:', resume.original_name);
    ...
    console.log('✅ Text extracted for Flask ML analysis, length:', extractedText.length);
    console.log('📄 First 500 characters:', extractedText.substring(0, 500));

    // Call Flask API for ML analysis
    console.log('🔗 Calling Flask ML API...');
    let flaskResponse;
    try {
      ...
      console.log('✅ Flask API responded successfully');
    } catch (flaskError) {
    ...
    console.log('🤖 Flask ML Analysis completed:', {
    ...
    console.log('💾 Saving Flask ML analysis to database...');
    try {
      ...
      console.log('✅ Flask ML analysis saved to database');
    } catch (dbError) {
    ...
    console.log('🎉 SUCCESS: Flask ML Resume analysis complete');
    ...
    console.error('💥 FLASK ML ANALYSIS ERROR:', error);
    ...
    console.log('🏁 === FLASK ML RESUME ANALYSIS FINISHED ===');
  }
}